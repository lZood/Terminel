...
export default function Hero() {
    const t = useTranslations('ToolsHero')
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-lg border border-white/20">
                                <Map size={20} />
                                <span className="font-medium">{t('silo_map')}</span>
                            </div>
                            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-lg border border-white/20">
                                <Calculator size={20} />
                            ...
                            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-lg border border-white/20">
                                <BookOpen size={20} />
                                <span className="font-medium">{t('tech_library')}</span>
                            </div>
                            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-lg border border-white/20">
                                ...
                                <span className="font-medium">{t('price_alerts')}</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
